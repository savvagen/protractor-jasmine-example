...
karma.protractor.conf.js         --> config file for running unit tests with Karma
e2e-tests/            --> end-to-end tests
  protractor-protractor.conf.js    --> Protractor config file
...
* The configuration is found at `karma.protractor.conf.js`.
...
* The configuration is found at `e2e-tests/protractor-protractor.conf.js`.
